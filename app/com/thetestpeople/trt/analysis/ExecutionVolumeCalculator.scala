...
class ExecutionVolumeCalculator {

  def countExecutions(executions: Iterator[ExecutionLite]): ExecutionVolumeAnalysisResult = {
    var allCounts: SortedMap[LocalDate, Int] = SortedMap()
    var countsByConfiguration: Map[Configuration, SortedMap[LocalDate, Int]] = Map()
